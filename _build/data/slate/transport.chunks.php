...
$chunks[1]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/st.slate_importwrapper_tpl.chunk.html'));
...
$chunks[2]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/st.slate_importmarker_tpl.chunk.html'));

$chunks[3] = $modx->newObject('modChunk');
$chunks[3]->fromArray(array (
  'id' => 3,
  'property_preprocess' => false,
  'name' => 'st.slate_structures',
...
$chunks[3]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/st.slate_structures.chunk.html'));
